    ...
    return ( 
        ...
        >
            ...
            <section
             ...
             className=" bg-gray-100 max-w-[42rem] rounded-lg group-even:pl-3 border border-black/5 overflow-hidden sm:pr-8 relative sm:min-h-[20rem]  flex flex-col items-center sm:block   hover:bg-gray-200 transition-all ease-in-out duration-300 dark:bg-white/10 dark:hover:bg-white/20  dark:text-white"  >
                <div className="pt-4 pb-8 px-5 sm:pl-10 sm:pr-2  sm:pt-10 sm:max-w-[60%] flex flex-col h-full sm:group-even:ml-[18rem]    ">
                    ...
                    <ul className="flex flex-wrap mt-4 gap-2 sm:mt-auto ">
                        {tags.map((tag , idx ) => (
                            <li className="bg-black/[0.7] px-3 py-1 text-[0.7rem] uppercase tracking-wider text-white rounded-full dark:text-white/70 "  key={idx} >
                                {tag}
                            </li>
                        ))}
                    </ul>
